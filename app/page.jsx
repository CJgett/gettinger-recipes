      ...
      <section className="home-content">
        <div className="narrow-section">
          ...
          <ImagePlusText
            ...
            pText={`The Gettinger Gang, that is! 
              
            As every other person from the US, we like food, and we like lots of it. I started making food with my mom as a kid, and we still cook together when I visit - our strategy for pies, where I make the crust and she makes the filling, has never once failed us :)
