...
export default function ThemeToggle() {
  ...
  const toggleTheme = (e) => {
    ...
    const toggles = document.querySelectorAll(".theme-toggle .toggle-checkbox");
    toggles.forEach(toggle => toggle.checked = newTheme);

    // Update classes and save preference
  ...
  return (
    <label className="theme-toggle custom-toggle" htmlFor={toggleId}>
      <span hidden>{theme ? 'Switch to light mode' : 'Switch to dark mode'}</span>
      <input 
        type="checkbox"
        ...
        role="switch"
      />
      <div className="toggle-button" aria-hidden="true">
